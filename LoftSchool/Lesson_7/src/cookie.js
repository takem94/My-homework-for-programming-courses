...
addButton.addEventListener('click', () => {
    if (addNameInput.value.length > 0 && addValueInput.value.length > 0) {
        ...
        // В тестах есть ошибка с проверкой, там берется значение из
        // самого поля, вместо того, чтобы создавать отдельные
        // переменные.
        // При использовании интерфейса, гораздо удобнее, когда
